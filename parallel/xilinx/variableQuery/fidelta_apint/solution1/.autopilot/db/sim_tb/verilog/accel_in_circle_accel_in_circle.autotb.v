...
`define AUTOTB_DUT      accel_in_circle_accel_in_circle
`define AUTOTB_DUT_INST AESL_inst_accel_in_circle_accel_in_circle
`define AUTOTB_TOP      apatb_accel_in_circle_top
`define AUTOTB_LAT_RESULT_FILE "accel_in_circle_accel_in_circle.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "accel_in_circle_accel_in_circle.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_accel_in_circle_top
...
`define AESL_DEPTH_indata_V 1
`define AESL_DEPTH_instate_V 1
`define AESL_DEPTH_infather_V 1
`define AESL_DEPTH_inmaxquery 1
`define AUTOTB_TVIN_gmem1  "./c.accel_in_circle_accel_in_circle.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem0  "./c.accel_in_circle_accel_in_circle.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem2  "./c.accel_in_circle_accel_in_circle.autotvin_gmem2.dat"
`define AUTOTB_TVIN_indata_V  "./c.accel_in_circle_accel_in_circle.autotvin_indata_V.dat"
`define AUTOTB_TVIN_instate_V  "./c.accel_in_circle_accel_in_circle.autotvin_instate_V.dat"
`define AUTOTB_TVIN_infather_V  "./c.accel_in_circle_accel_in_circle.autotvin_infather_V.dat"
`define AUTOTB_TVIN_inmaxquery  "./c.accel_in_circle_accel_in_circle.autotvin_inmaxquery.dat"
`define AUTOTB_TVIN_gmem1_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_gmem1.dat"
`define AUTOTB_TVIN_gmem0_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_gmem0.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_gmem2.dat"
`define AUTOTB_TVIN_indata_V_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_indata_V.dat"
`define AUTOTB_TVIN_instate_V_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_instate_V.dat"
`define AUTOTB_TVIN_infather_V_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_infather_V.dat"
`define AUTOTB_TVIN_inmaxquery_out_wrapc  "./rtl.accel_in_circle_accel_in_circle.autotvin_inmaxquery.dat"
`define AUTOTB_TVOUT_gmem0  "./c.accel_in_circle_accel_in_circle.autotvout_gmem0.dat"
`define AUTOTB_TVOUT_gmem0_out_wrapc  "./impl_rtl.accel_in_circle_accel_in_circle.autotvout_gmem0.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_gmem1 = 4;
parameter LENGTH_gmem0 = 4;
parameter LENGTH_gmem2 = 1;
parameter LENGTH_indata_V = 1;
parameter LENGTH_instate_V = 1;
parameter LENGTH_infather_V = 1;
parameter LENGTH_inmaxquery = 1;
...
wire  gmem2_WVALID;
wire  gmem2_WREADY;
wire [255 : 0] gmem2_WDATA;
wire [31 : 0] gmem2_WSTRB;
wire  gmem2_WLAST;
wire [0 : 0] gmem2_WID;
...
AESL_axi_master_gmem0 AESL_AXI_MASTER_gmem0(
    ...
    .TRAN_gmem0_instate_V (instate_V),
...
AESL_axi_master_gmem2 AESL_AXI_MASTER_gmem2(
    ...
    .TRAN_gmem2_infather_V (infather_V),
...
AESL_axi_slave_control AESL_AXI_SLAVE_control(
    ...
    .TRAN_indata_V (indata_V),
    .TRAN_instate_V (instate_V),
    .TRAN_infather_V (infather_V),
...
reg end_indata_V;
reg [31:0] size_indata_V;
reg [31:0] size_indata_V_backup;
reg end_instate_V;
reg [31:0] size_instate_V;
reg [31:0] size_instate_V_backup;
reg end_infather_V;
reg [31:0] size_infather_V;
reg [31:0] size_infather_V_backup;
reg end_inmaxquery;
reg [31:0] size_inmaxquery;
reg [31:0] size_inmaxquery_backup;

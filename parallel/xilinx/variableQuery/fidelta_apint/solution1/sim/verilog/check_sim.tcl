...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.accel_in_circle_accel_in_circle.autotvin_gmem1.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_gmem0.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_gmem2.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_indata_V.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_instate_V.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_infather_V.dat"
         "c.accel_in_circle_accel_in_circle.autotvin_inmaxquery.dat"
         "c.accel_in_circle_accel_in_circle.autotvout_gmem0.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.accel_in_circle_accel_in_circle.autotvout_gmem0.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

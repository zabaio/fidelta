...
module AESL_axi_master_gmem2 (
    ...
    TRAN_gmem2_BID,
    TRAN_gmem2_BUSER,
    TRAN_gmem2_infather_V,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_gmem2 "../tv/cdatafile/c.accel_in_circle_accel_in_circle.autotvin_gmem2.dat"
`define TV_OUT_gmem2 "../tv/rtldatafile/rtl.accel_in_circle_accel_in_circle.autotvout_gmem2.dat"
 parameter gmem2_ADDR_BITWIDTH = 32'd 64;
 parameter gmem2_AWUSER_BITWIDTH = 32'd 1;
 parameter gmem2_DATA_BITWIDTH = 32'd 256;
 parameter gmem2_WUSER_BITWIDTH = 32'd 1;
 parameter gmem2_ID_BITWIDTH = 32'd 1;
 parameter gmem2_RUSER_BITWIDTH = 32'd 1;
 parameter gmem2_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter gmem2_C_DATA_BITWIDTH = 32'd 256;
parameter gmem2_mem_depth = 32'd 1;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_gmem2_AWVALID;
output  TRAN_gmem2_AWREADY;
input [gmem2_ADDR_BITWIDTH - 1 : 0] TRAN_gmem2_AWADDR;
input [gmem2_ID_BITWIDTH - 1 : 0] TRAN_gmem2_AWID;
input [8 - 1 : 0] TRAN_gmem2_AWLEN;
input [3 - 1 : 0] TRAN_gmem2_AWSIZE;
input [2 - 1 : 0] TRAN_gmem2_AWBURST;
input [2 - 1 : 0] TRAN_gmem2_AWLOCK;
input [4 - 1 : 0] TRAN_gmem2_AWCACHE;
input [3 - 1 : 0] TRAN_gmem2_AWPROT;
input [4 - 1 : 0] TRAN_gmem2_AWQOS;
input [4 - 1 : 0] TRAN_gmem2_AWREGION;
input [gmem2_AWUSER_BITWIDTH - 1 : 0] TRAN_gmem2_AWUSER;
input  TRAN_gmem2_WVALID;
output  TRAN_gmem2_WREADY;
input [gmem2_DATA_BITWIDTH - 1 : 0] TRAN_gmem2_WDATA;
input [gmem2_DATA_BITWIDTH/8 - 1 : 0] TRAN_gmem2_WSTRB;
input  TRAN_gmem2_WLAST;
input  TRAN_gmem2_WID;
input [gmem2_WUSER_BITWIDTH - 1 : 0] TRAN_gmem2_WUSER;
input  TRAN_gmem2_ARVALID;
output  TRAN_gmem2_ARREADY;
input [gmem2_ADDR_BITWIDTH - 1 : 0] TRAN_gmem2_ARADDR;
input [gmem2_ID_BITWIDTH - 1 : 0] TRAN_gmem2_ARID;
input [8 - 1 : 0] TRAN_gmem2_ARLEN;
input [3 - 1 : 0] TRAN_gmem2_ARSIZE;
input [2 - 1 : 0] TRAN_gmem2_ARBURST;
input [2 - 1 : 0] TRAN_gmem2_ARLOCK;
input [4 - 1 : 0] TRAN_gmem2_ARCACHE;
input [3 - 1 : 0] TRAN_gmem2_ARPROT;
input [4 - 1 : 0] TRAN_gmem2_ARQOS;
input [4 - 1 : 0] TRAN_gmem2_ARREGION;
input  TRAN_gmem2_ARUSER;
output  TRAN_gmem2_RVALID;
input  TRAN_gmem2_RREADY;
output [gmem2_DATA_BITWIDTH - 1 : 0] TRAN_gmem2_RDATA;
output  TRAN_gmem2_RLAST;
output [gmem2_ID_BITWIDTH - 1 : 0] TRAN_gmem2_RID;
output [gmem2_RUSER_BITWIDTH - 1 : 0] TRAN_gmem2_RUSER;
output [2 - 1 : 0] TRAN_gmem2_RRESP;
output  TRAN_gmem2_BVALID;
input  TRAN_gmem2_BREADY;
output [2 - 1 : 0] TRAN_gmem2_BRESP;
output [gmem2_ID_BITWIDTH - 1 : 0] TRAN_gmem2_BID;
output [gmem2_BUSER_BITWIDTH - 1 : 0] TRAN_gmem2_BUSER;
output [64 - 1 : 0] TRAN_gmem2_infather_V;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [gmem2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem2_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [gmem2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [gmem2_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [gmem2_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [gmem2_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [gmem2_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [64 - 1 : 0] infather_V = 0;
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_0 [0: gmem2_mem_depth - 1]; 
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_1 [0: gmem2_mem_depth - 1]; 
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_2 [0: gmem2_mem_depth - 1]; 
reg [gmem2_DATA_BITWIDTH - 1 : 0] gmem2_mem_3 [0: gmem2_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [gmem2_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [gmem2_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [gmem2_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_gmem2_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_gmem2_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_gmem2_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_gmem2_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_gmem2_BRESP = BRESP_tmp;
assign TRAN_gmem2_RDATA = RDATA_tmp;
assign TRAN_gmem2_RRESP = RRESP_tmp;
assign TRAN_gmem2_RLAST = RLAST_tmp;
assign TRAN_gmem2_RVALID = RVALID_tmp;
assign    TRAN_gmem2_infather_V = infather_V;
...
initial begin : initialize_offset
  ...
  infather_V <= 0 * DATA_byte_num;
end

initial begin : initialize_gmem2_mem
  integer i;
  for (i = 0; i < gmem2_mem_depth; i = i + 1) begin
      gmem2_mem_0[i] = 0;
      gmem2_mem_1[i] = 0;
      gmem2_mem_2[i] = 0;
      gmem2_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem2_AWREADY & TRAN_gmem2_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_gmem2_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_gmem2_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_gmem2_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_gmem2_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem2_ARREADY & TRAN_gmem2_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_gmem2_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_gmem2_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_gmem2_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_gmem2_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_gmem2_WREADY & TRAN_gmem2_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem2_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_gmem2_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_gmem2_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem2_AWVALID && TRAN_gmem2_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem2_ARVALID && TRAN_gmem2_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem2_WVALID && TRAN_gmem2_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_gmem2_WVALID && TRAN_gmem2_WREADY && TRAN_gmem2_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_gmem2_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_gmem2_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [gmem2_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [gmem2_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [gmem2_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/users/alberto.giusti/Desktop/backup/variableQuery/fidelta_apint/solution1/sim/verilog/AESL_axi_master_gmem2.v: Write request address %d exceed AXI master gmem2 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = gmem2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = gmem2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = gmem2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : gmem2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : gmem2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : gmem2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = gmem2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = gmem2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = gmem2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = gmem2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : gmem2_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : gmem2_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : gmem2_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : gmem2_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem2_mem_depth) begin
                $display ("/home/users/alberto.giusti/Desktop/backup/variableQuery/fidelta_apint/solution1/sim/verilog/AESL_axi_master_gmem2.v: Read request address %d exceed AXI master gmem2 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem2_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= gmem2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= gmem2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= gmem2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_gmem2_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= gmem2_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= gmem2_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= gmem2_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= gmem2_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer gmem2_bitwidth; 
  reg [535 : 0] token; 
  reg [535 : 0] token_tmp; 
  //reg [gmem2_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [gmem2_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  gmem2_bitwidth = gmem2_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (gmem2_bitwidth , factor);
  fp = $fopen(`TV_IN_gmem2,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_gmem2); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [gmem2_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 1 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : gmem2_mem_0[i/factor] = mem_tmp;
                      1 : gmem2_mem_1[i/factor] = mem_tmp;
                      2 : gmem2_mem_2[i/factor] = mem_tmp;
                      3 : gmem2_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : gmem2_mem_0[i] = mem_tmp;
                  1 : gmem2_mem_1[i] = mem_tmp;
                  2 : gmem2_mem_2[i] = mem_tmp;
                  3 : gmem2_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [gmem2_DATA_BITWIDTH - 1: 0] = 0;
          end

...
if {[file isfile accel_in_circle_accel_in_circle.autotvin.dat]} {
	file delete -force accel_in_circle_accel_in_circle.autotvin.dat
}

if {[file isfile accel_in_circle_accel_in_circle.autotvout.dat]} {
	file delete -force accel_in_circle_accel_in_circle.autotvout.dat
}

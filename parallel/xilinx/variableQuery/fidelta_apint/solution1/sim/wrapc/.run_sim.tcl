...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "accel_in_circle_accel_in_circle.autotvin.dat"
	set constFileTvOut       "accel_in_circle_accel_in_circle.autotvout.dat"
	set constFileHdlTvIn     "accel_in_circle_accel_in_circle.autohdltvin.dat"
	set constFileHdlTvOut    "accel_in_circle_accel_in_circle.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

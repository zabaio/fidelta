...
void accel_in_circle(ap_uint<512> *indata, ap_uint<64> *instate){
	...
	const int prof = MAXQUERY/2;
    #pragma HLS INTERFACE m_axi port=instate offset=slave bundle=gmem0 depth=prof
	#pragma HLS INTERFACE m_axi port=indata offset=slave bundle=gmem1 depth=prof

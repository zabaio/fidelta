...
# 305 "/opt/Xilinx/Vivado/2019.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
_ssdm_op_SpecInterface(inpts, "m_axi", 0, 0, "", 0, 0, "gmem0", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(indata, "m_axi", 0, 0, "", 0, 0, "gmem0", "slave", "", 16, 16, 16, 16, "", "");
_ssdm_op_SpecInterface(outresult, "m_axi", 0, 0, "", 0, 0, "gmem0", "slave", "", 16, 16, 16, 16, "", "");

_ssdm_op_SpecInterface(init, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(inpts, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(indata, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(outresult, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");
_ssdm_op_SpecInterface(0, "s_axilite", 0, 0, "", 0, 0, "control", "", "", 0, 0, 0, 0, "", "");

 static const point pts[300];
_ssdm_SpecConstant(pts);
# 38 "merge_round.c"

_ssdm_SpecArrayPartition( &printf, 1, "COMPLETE", 0, "");
 ...
 if (*init == 1){
  ...
  memcpy(&data[0][0], indata, 4*100*sizeof(int));
  int i;
  for (i = 0; i < 100; i++){
  ...
  memcpy(outresult, result, 100*sizeof(int));
 }
 return;
}

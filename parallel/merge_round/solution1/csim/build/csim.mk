...
$(ObjDir)/checkresult.o: ../../../../checkresult.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../checkresult.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
...
$(ObjDir)/merge_round.o: ../../../../merge_round.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../merge_round.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/merge_round.d
